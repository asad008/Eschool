                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <?php
                                        include('backconnect.php');
                                        $adname = "SELECT email FROM super_admin WHERE email='$_SESSION[user]'AND passwor='$_SESSION[pass]'";
                                        $resultoo = mysqli_query($conn, $adname);
                                        $row = mysqli_fetch_assoc($resultoo);
                                        $usname = $row['email'];
                                        echo $usname;
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                (+880) <?php
                                        include('backconnect.php');
                                        $adname = "SELECT Phone FROM super_admin WHERE email='$_SESSION[user]'AND passwor='$_SESSION[pass]'";
                                        $resultoo = mysqli_query($conn, $adname);
                                        $row = mysqli_fetch_assoc($resultoo);
                                        $usname = $row['Phone'];
                                        echo $usname;
