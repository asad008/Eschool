                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="needs-validation" action="backinsert_teacher.php" method="POST" enctype="multipart/form-data" novalidate>
                                    <div class="row">

                                        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 ">

                                            <label for="validationCustom01">Teachers Photo</label>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <input type="text" class="form-control" id="validationCustom01" name="tid" required>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <input type="text" class="form-control" id="validationCustom01" name="cphone" required>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <input type="text" class="form-control" id="validationCustom01" name="tname" required>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <input type="tel" class="form-control" id="validationCustom01" pattern="[0-9]{13,13}" name="tbcn" required>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <input type="date" class="form-control" id="validationCustom01" name="tdob" required>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                                            <div class="form-group">
                                                ...
                                                echo "<select class='form-control' id='input-select' name='tgender' required>";
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                                            <div class="form-group">
                                                ...
                                                echo "<select class='form-control' id='input-select' name='treligion'>";
                                                foreach ($options as $option) {
                                                    if ($selected == $option) {
                                                        echo "<option selected='selected' value='$option'>$option</option>";
                                                    } else {
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <input type="text" class="form-control" id="validationCustom02" name="dept">
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <input type="text" class="form-control" id="validationCustom02" name="faculty">
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
