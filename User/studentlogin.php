    ...
    <div class="background">
        ...
        <div class="form-box">
            ...
            <form action="index.php" method="POST">
                ...
                <h2 style="color: #2A3F54 ">Student Panel</h2>
                <input type="email" class="input-field" placeholder="Enter Username" name="susername" required="" oninvalid="this.setCustomValidity('Please enter a valid Email')" oninput="setCustomValidity('')">
                <input type="password" class="input-field" placeholder="Enter Password" name="spassword" required="" oninvalid="this.setCustomValidity('Password is required')" oninput="setCustomValidity('')">
