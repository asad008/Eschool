...
<body>
    <div class="col-md-12 col-sm-12 col-12">
        <div class="card">
        <h5 style="text-align: center;" class="card-header">Assign Teacher</h5>
            <div class="card-body">
                ...
                <table id="dtBasicExample" class="sortable" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<tr><td>" . $row['class'] . "</td><td>" . $row['section'] . "</td><td>" . $row['book'] . "</td><td>" . $row['teacherid'] . "</td><td>" .
                                " 
                                <a href='backeditassignteacher.php?si=$row[class] && sec=$row[section]&& book=$row[subjectcode]'><i class='fas fa-pencil-alt' title='Edit'></i></a>
                                
                                <a href='backdeletestudent.php'><i class='fas fa-trash-alt' title='Delete' alt='Id Card'></i></a>" .
                                "</td></tr>";
                        }
