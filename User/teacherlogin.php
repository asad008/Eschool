...
<head>
    ...
    <script src="teacherloginscript.js"></script>
...
<body>
    <div class="background">
        ...
        <div class="form-box1">
            ...
            <p>Login To Your Profile From Here To Access.</p>
        </div>
        <div class="form-box">
            ...
            <form action="index.php" method="POST">
                ...
                <h2 style="color: #2A3F54 ">Teachers Panel</h2>
                <input type="email" class="input-field" placeholder="Enter Email" name="tusername" required="" oninvalid="this.setCustomValidity('Please enter a valid Email')" oninput="setCustomValidity('')">
                <input type="password" class="input-field" placeholder="Enter Password" name="tpassword" required="" oninvalid="this.setCustomValidity('Password is required')" oninput="setCustomValidity('')">
